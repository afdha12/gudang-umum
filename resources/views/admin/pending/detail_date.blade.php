...
@section('title', 'Detail Pending - ' . \Carbon\Carbon::parse($date)->format('d M Y'))
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <a href="{{ route('pending.index', ['view' => 'date']) }}" class="text-decoration-none text-muted small">
                    <i class="bi bi-arrow-left me-1"></i>Kembali ke Monitoring
                </a>
                <h4 class="fw-bold text-dark mb-0 mt-1">
                    <i class="bi bi-calendar3 me-2"></i>Permintaan Pending: {{ \Carbon\Carbon::parse($date)->format('d M Y') }}
                </h4>
                <p class="text-muted mb-0 small">{{ \Carbon\Carbon::parse($date)->translatedFormat('l') }}</p>
            </div>
        </div>
                                ...
                                <tr>
                                    <td colspan="6" class="py-5 text-center">
                                        <div class="text-muted">
                                            ...
                                            <span>Tidak ada permintaan pending pada tanggal ini</span>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse

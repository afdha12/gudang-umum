<li class="nav-item"><a class="nav-link" href="{{ route('manager.dashboard') }}">
        <svg class="nav-icon">
...
<li class="nav-item">
    <a class="nav-link {{ request()->is('manager/item_demands*') ? 'active' : '' }}"
        href="{{ route('item_demands.index') }}">
...
{{-- <li class="nav-group {{ request()->is('manager/item_demands*') ? 'show' : '' }}">
    <a class="nav-link nav-group-toggle" href="#">
        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            class="bi bi-journal-check" viewBox="0 0 16 16">
            <path fill-rule="evenodd"
